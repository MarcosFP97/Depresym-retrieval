...
response: ChatResponse = chat(model='llama3:8b-instruct-q4_0', messages=[
  {
    'role': 'user',
    'content': 'For the of the 21 Beck Depression Inventory (BDI) questionnaire, I want you to generate 10 examples of sentences.' \
               ...
               'These are the 21 symptoms between [] I want you to stick to them and generate 20 examples for each: ' \
               '[ Irritability, Concentration Difficulty].' \
               'Just answer with a JSON in which the key is the symptom name and the values a list of ten sentences. Please use only the 21 symptoms listed before between []',
  },
])
